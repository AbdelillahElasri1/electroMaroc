    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
      ...
      foreach ($post as $key => $value) { ?>
        <tr>
                <!-- <th scope="col" class="flex w-20 h-20 items-center px-6 py-4 text-gray-900 whitespace-nowrap">
                <img class="w-10 h-10 rounded-full" src="" alt="Category image">
                </th> -->
                <th scope="col" class="px-6 py-3">
                <?= $value['categoryName'] ?>
                </th>
                <th scope="col" class="text-light text-sm overflow-auto">
                  <p class="overflow-y-auto max-h-20 font-light text-xs"> <?= $value['categoryDescription'] ?>
</p>
                </th>
                <th scope="col" class="px-6 py-3">
                    0
                </th>
                <th scope="col" class="px-6 py-3 flex space-x-4 my-auto">
                <?php if ($value['hide'] == 0) { ?>
